    ...
    public class McConnectionInfo
    {
        ...
        public override string ToString()
        {
            string McConnectionStr =
                 string.Format("UFT Digital Lab HostAddress: {0}, Port: {1}, Username: {2}, TenantId: {3}, UseSSL: {4}, UseProxy: {5}, ProxyType: {6}, ProxyAddress: {7}, ProxyPort: {8}, ProxyAuth: {9}, ProxyUser: {10}",
